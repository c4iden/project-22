...
function setup() {
	...
	bob1 = Bodies.circle(400,400,bob_radius,bob_options);
  	World.add(world,bob1);

	  bob2 = Bodies.circle(430,400,bob_radius,bob_options);
  	World.add(world,bob2);

	  bob3 = Bodies.circle(460,400,bob_radius,bob_options);
  	World.add(world,bob3);

	  bob4 = Bodies.circle(490,400,bob_radius,bob_options);
  	World.add(world,bob4);

	  bob5 = Bodies.circle(520,400,bob_radius,bob_options);
